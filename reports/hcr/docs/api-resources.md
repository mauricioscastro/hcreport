...
<tr><td  id="td_table" colspan="2" style="border-width:5px"><b>Kind:</b> {{resource.kind}}</td></tr>
<tr><td  id="td_table" style="border-width:5px">{{resource.name}}</td><td id="td_table" style="border-width:5px">{{resource.groupVersion}}</td></tr>
